...
User.create(name: "MinhP", email: "a@a.com", instructions: "bitcoins pls", password: "woop", password_confirmation: "woop")
User.create(name: "prnd", email: "b@a.com", instructions: "is food store open", password: "meshiya", password_confirmation: "meshiya")